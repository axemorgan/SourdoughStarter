...
object Dependencies {
    private object Versions {
        ...
        const val junit5AndroidTests = "1.3.0"
    ...
    const val junit5AndroidTestCore =
        "de.mannodermaus.junit5:android-test-core:${Versions.junit5AndroidTests}"
    const val junit5AndroidTestRunner =
        "de.mannodermaus.junit5:android-test-runner:${Versions.junit5AndroidTests}"
    ...
    /**
     * When using JUnit 5 for Android tests, also make sure to set the test runner to AndroidJUnitRunner, or
     * a subclass of it. Note that JUnit 5 requires Java 8, so these tests will only run on devices running
     * Android API 26 or higher.
     * ```
     * testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner`
     * ```
     */
    fun DependencyHandlerScope.junit5AndroidTests() {
        add("androidTestImplementation", AndroidX.testRunner)
        add("androidTestImplementation", jupiterApi)
        add("androidTestImplementation", junit5AndroidTestCore)
        add("androidTestRuntimeOnly", junit5AndroidTestRunner)
    }
